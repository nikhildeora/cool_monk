let videoGame_arr = [
    ...
    },
    {
        ...
        rating:  3 ,
        desc: "Sold by GamesnGadgetsPlus",
        price: 4513
    },
    {
        id: 17,
    ...
    },
    {
        ...
        image: "https://img.shop.com/Image/270000/274900/274929/products/1928470149.jpg?plain&size=450x450",
        rating:  2 ,
        desc: "Sold by Electronic Express",
        price: 2530
    },
    {   id:29,
...
// console.log( videoGame_arr)
display(videoGame_arr)
function display(videoGame_arr){
    console.log(videoGame_arr)
videoGame_arr.forEach( (el)=> {
    console.log(el)
    ...
    card.append(img, name, rating, price, desc)
